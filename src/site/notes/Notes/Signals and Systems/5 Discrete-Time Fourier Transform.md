---
{"dg-publish":true,"permalink":"/notes/signals-and-systems/5-discrete-time-fourier-transform/","hide":"true","updated":"2025-02-09T22:01:09.000+01:00"}
---
...
| :-----------------------------------------: | :-----------------------------------------------------------------------------------------------------------------------------------------------: | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: |
|                                             |                                                                      $x[n]$                                                                       |                                                                                                                                                                                                             $\left.X\left(e^{i \omega}\right)\right\}$ periodic with                                                                                                                                                                                                             |
|                                             |                                                                      $y[n]$                                                                       |                                                                                                                                                                                                                   $Y\left(e^{i \omega}\right)$ period $2 \pi$                                                                                                                                                                                                                    |
...
|           **Frequency Shifting**            |                                                              $e^{i \omega_0 n} x[n]$                                                              |                                                                                                                                                                                                                $X\left(e^{j\left(\omega-\omega_0\right)}\right)$                                                                                                                                                                                                                 |
...
|             **Multiplication**              |                                                                    $x[n] y[n]$                                                                    |                                                                                                                                                                                       $\frac{1}{2 \pi} \int_{2 \pi} X\left(e^{ \theta}\right) Y\left(e^{i(\omega-\theta)}\right) d \theta$                                                                                                                                                                                       |
...
|      **Differentiation in Frequency**       |                                                                     $n x[n]$                                                                      |                                                                                                                                                         $\begin{aligned}& +\pi X\left(e^{j 0}\right) \sum_{k=-\infty}^{+\infty} \delta(\omega-2 \pi k) \\& j \frac{d X\left(e^{i \omega}\right)}{d \omega}\end{aligned}$                                                                                                                                                         |
|   **Conjugate Symmetry for Real Signals**   |                                                                    $x[n]$ real                                                                    | $\left\{\begin{array}{l}X\left(e^{i \omega}\right)=X^*\left(e^{-i \omega}\right) \\\mathfrak{Re}\left\{X\left(e^{i \omega}\right)\right\}=\mathfrak{Re}\left[X(e^{-i \omega})\right] \\\mathfrak{Im}\left[X(e^{i \omega})\right]=-\mathfrak{Im}\left[X(e^{-i \omega})\right] \\\left\|X\left(e^{i \omega}\right)\right\|=\left\|X\left(e^{-i \omega}\right)\right\| \\\sphericalangle X\left(e^{i \omega}\right)=-\sphericalangle X\left(e^{-i \omega}\right)\end{array}\right.$ |
...
| **Even-odd Decomposition of Real Signals**  | $\begin{array}{ll}x_c[n]=\mathcal{E}\{x[n]\} & {[x[n] \text { real }]} \\x_{\varphi}[n]=\mathcal{O}\{x[n]\} & {[x[n] \text { real }]}\end{array}$ |                                                                                                                                                               $\begin{aligned}& \mathfrak{Re}\left\{X\left(e^{i \omega}\right)\right\} \\& i \mathfrak{Im}\left\{X\left(e^{i \omega}\right)\right\}\end{aligned}$                                                                                                                                                                |
| **Parseval's Ration for Aperiodic Signals** |               $\sum_{n=-\infty}^{+\infty}\|x[n]\|=\frac{1}{2 \pi} \int_{2 \pi}\left\|X\left(e^{i \omega}\right)\right\|^2 d \omega$               |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
In addition to the duality between the discrete Fourier series and the continuous-time Fourier series, a similar duality exists between the discrete-time Fourier transform and the continuous-time Fourier series.
