...
|                **Integration**                |                                     $\int_{-\infty}^t x(\tau) \, d\tau$                                      |                                                                     $\frac{1}{i \omega} X(i \omega) + \pi X(0) \delta(\omega)$                                                                      |
...
| **Parseval's Relation for Aperiodic Signals** | $\int_{-\infty}^\infty \|x(t)\|^2 \, dt = \frac{1}{2\pi} \int_{-\infty}^\infty \|X(i \omega)\|^2 \, d\omega$ |                                                                                                                                                                                                     |
