...
We will primarily work with wavelengths in the visible and infrared range, spanning approximately $400\,\mathrm{nm}$ to $10\,\mu\mathrm{m}$, with photon energies ranging from about $0.1\,\mathrm{eV}$ to a few $\mathrm{eV}$. These scales are crucial for understanding optical and optoelectronic devices, including semiconductor lasers, modulators, and detectors.

The course progresses from field theory to devices. Maxwell's equations and material response define wave propagation; interfaces, diffraction, resonators, and guided modes define how fields are shaped; and the laser chapters connect those field concepts to gain, feedback, and coherent light generation.
